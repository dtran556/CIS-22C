...
public class LinkedList<T> {
   ...
   /**
     ...
     * @precondition if iterator is null
     * @throws NullPointerException when precondition is violated
     */
    public int getIteratorIndex() throws NullPointerException {
    	int count = 0;
    	if (iterator == null) { 
	         throw new NullPointerException("getIteratorIndex(): Cannot get index because iterator points to null"); 
	      } 
    	else
    	{	
    		Node temp = iterator;
    ...
    public void advanceIteratorToIndex(int index) throws NullPointerException {
    	...
    	if(iterator == null)
    	{
    		throw new NullPointerException("AdvanceiteratorToIndex(): Cannot get index because iterator points to null"); 
    	}
    	while(temp != null)
    	{
