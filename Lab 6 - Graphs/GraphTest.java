...
class GraphTest {
    ...
    void testGetDistance() {
        ...
        assertThrows(IndexOutOfBoundsException.class, ()->{g.getDistance(5);});
        assertThrows(IndexOutOfBoundsException.class, ()->{g.getDistance(0);});
    ...
    void testGetParent() {
        ...
        assertThrows(IndexOutOfBoundsException.class, ()->{g.getParent(5);});
        assertThrows(IndexOutOfBoundsException.class, ()->{g.getParent(0);});
    }
    ...
    void testGetColor() {
        ...
        assertThrows(IndexOutOfBoundsException.class, ()->{g.getColor(5);});
        assertThrows(IndexOutOfBoundsException.class, ()->{g.getColor(0);});
    }
    ...
    void testGetDiscoverTime() {
        ...
        assertThrows(IndexOutOfBoundsException.class, ()->{g.getDiscoverTime(6);});
        assertThrows(IndexOutOfBoundsException.class, ()->{g.getDiscoverTime(0);});
    }
    ...
    void testGetFinishTime() {
        ...
        assertThrows(IndexOutOfBoundsException.class, ()->{g.getFinishTime(6);});
        assertThrows(IndexOutOfBoundsException.class, ()->{g.getFinishTime(0);});
    ...
    void testGetAdjacencyList() {
        ...
        assertThrows(IndexOutOfBoundsException.class, ()->{g.getAdjacencyList(5);});
        assertThrows(IndexOutOfBoundsException.class, ()->{g.getAdjacencyList(0);});
    }
    ...
    void testAddDirectedEdge() {
        ...
        assertEquals("1: 2 3 \n" +
                ...
                "3: 4 \n" +
                "4: \n", g.toString());
        assertThrows(IndexOutOfBoundsException.class, ()->{g.addDirectedEdge(5, 2);});
        assertThrows(IndexOutOfBoundsException.class, ()->{g.addDirectedEdge(0, 2);});
        assertThrows(IndexOutOfBoundsException.class, ()->{g.addDirectedEdge(2, 5);});
        assertThrows(IndexOutOfBoundsException.class, ()->{g.addDirectedEdge(2, 0);});
    }
    ...
    void testAddUndirectedEdge() {
        ...
        assertEquals("1: 2 3 \n" +
                ...
                "3: 1 4 \n" +
                "4: 2 3 \n", g.toString());
        assertThrows(IndexOutOfBoundsException.class, ()->{g.addUndirectedEdge(5, 2);});
        assertThrows(IndexOutOfBoundsException.class, ()->{g.addUndirectedEdge(0, 2);});
        assertThrows(IndexOutOfBoundsException.class, ()->{g.addUndirectedEdge(2, 5);});
        assertThrows(IndexOutOfBoundsException.class, ()->{g.addUndirectedEdge(2, 0);});
    }
    ...
    void testBFS() {
        ...
        assertThrows(IndexOutOfBoundsException.class, ()->{g.BFS(0);});
        assertThrows(IndexOutOfBoundsException.class, ()->{g.BFS(11);});
        g.BFS(1);
